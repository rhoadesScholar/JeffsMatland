function optoMats = showOptoCalMats(calMats, stims, durations, strains, showTogether)% durations is nx2 array of [duration of pause before stim, duration of stim]

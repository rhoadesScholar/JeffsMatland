function Ring = find_ring(global_background, localpath, FilePrefix, manualflag)
...
if(isnan(Ring.PixelSize))
    ...
    Ring = cant_find_square_ring(global_background, localpath, FilePrefix, manualflag);
...
function Ring = cant_find_square_ring(background, localpath, FilePrefix, manualflag)

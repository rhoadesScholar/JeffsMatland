...
% function p=ksdensity2(x,N,h,xylim,alpha)
% ksdensity2  Bivariate Gaussian Kernel Density Estimation
% 
% Usage:
% p = ksdensity2(d) returns an estmate of the probability density function (pdf)
...
% p = ksdensity2(d,p) specifies optional parameters for the estimation:
...
%
% Without output, ksdensity2(d) and ksdensity2(d,p) will disply the pdf and cdf plots.  
%
% See also: hist, histc, ksdensity, ecdf, cdfplot, ecdfhist

% Example 1: two-peak normal distribution
%{
ksdensity2([randn(500,2);randn(500,1)+5 randn(500,1)]);
%}
% Example 2: four-peak normal distribution
%{
ksdensity2([randn(100,1), (randn(100,1)-10)*2;

function CC = custom_bwconncomp(varargin)
% CC = custom_bwconncomp(varargin)
% removes time-consuming input checks
...
[startRow,endRow,startCol,labelForEachRun,CC.NumObjects] = labelBinaryRuns(BW,conn);
...
CC.PixelIdxList = pixelIdxLists(size(BW),CC.NumObjects,objectSizes,startRow,...

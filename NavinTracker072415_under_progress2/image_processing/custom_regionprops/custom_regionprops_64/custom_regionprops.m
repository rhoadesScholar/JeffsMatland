...
% narginchk(1, inf, nargin, mfilename);
...
for k = 1 : numProps
    if ischar(propList{k})
        ...
        if noGrayscaleImageAsInput
            ...
            % prop = iptcheckstrs(propList{k}, tempStats, mfilename, 'PROPERTIES', k);
            prop = validatestring(propList{k}, tempStats, mfilename, 'PROPERTIES', k);

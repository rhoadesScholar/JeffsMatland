function chemotaxis_tracker_master_emily(movienames, ref_movie, plate_type, framerate)
...
for(i=1:length(movienames))
    chemotaxis_tracker_emily({movienames{i}, ref_movie}, plate_type, framerate, trackflag);
end

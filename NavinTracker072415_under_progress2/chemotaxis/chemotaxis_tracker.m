function chemotaxis_tracker(MovieName, plate_type, FrameRate, track_flag)
...
save_Tracks(sprintf('%s.odor_angle_linkedTracks.mat',prefix),target_odor_linkedTracks);
...
target_odor_linkedTracks = values_to_track_custom_metric(target_odor_linkedTracks, 'odor_distance');
save_Tracks(sprintf('%s.odor_distance_linkedTracks.mat',prefix),target_odor_linkedTracks);
BinData_odor_distance_target = attribute_vs_custom_metric(target_odor_linkedTracks, 'distance to target odor (mm)', 5);

function newmap = blue_red_colormap(cmin_input,cmax_input)
...
%   the max value of color values designed.  e.g. colormap(blue_red_colormap(-3,5))
%   
...
%   opposite number
%   e.g. colormap(blue_red_colormap(-3,6))   is from light blue to deep red
%   e.g. colormap(blue_red_colormap(-3,3))   is from deep blue to deep red
%
...
%   figure
%   peaks;
%   colormap(blue_red_colormap(-6,8)), colorbar, title('blue_red_colormap')
%   

% newmap = [linspace(0,1,100)', linspace(0,1,100)', ones(100,1); ones(100,1), linspace(1,0,100)', linspace(1,0,100)'];
% return;

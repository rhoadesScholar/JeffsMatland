function [legend_h,object_h,plot_h,text_strings] = columnlegend(numcolumns, plot_ptr, str, varargin)
%
%   columnlegend creates a legend with a specified number of columns.
%   
%   columnlegend(numcolumns, plot_ptr, str, varargin)
%       numcolumns - number of columns in the legend
%       plot_ptr - array of plots/variables for the legend
...
%create the legend
[legend_h,object_h,plot_h,text_strings] = legend(plot_ptr, str);

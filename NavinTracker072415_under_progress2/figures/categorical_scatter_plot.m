function handles = categorical_scatter_plot(varargin)
%categorical_scatter_plot plots distributions of points by spreading them around the y-axis
%
% SYNOPSIS: handles = categorical_scatter_plot(data,binWidth,spreadFcn,xNames,showMM,xValues)
%           handles = categorical_scatter_plot(ah,...)
%
...
%
% REMARKS: categorical_scatter_plot is useful for distributions with a small number of
%          data points. For larger amounts of data, distributionPlot is
%          more suited.
%
% EXAMPLES: data = {randn(25,1),randn(100,1),randn(300,1)};
%           figure,categorical_scatter_plot(data,[],[],{'25 pts','100 pts','300 pts'})
%
%            data = [randn(50,1);randn(50,1)+3.5]*[1 1];
%            catIdx = [ones(50,1);zeros(50,1);randi([0,1],[100,1])];
%            figure
%            categorical_scatter_plot(data,'categoryIdx',catIdx,...
...
parserObj.FunctionName = 'categorical_scatter_plot';

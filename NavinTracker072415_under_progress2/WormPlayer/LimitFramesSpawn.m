% --------------------------------------------------------
function LimitFramesSpawn(hbutton, eventStruct, hfig)
% 
...
% set(STR, 'string', ['Full track frames: ' num2str(BegFrameNum) ':' num2str(EndFrameNum)]);
...
tr = extract_track_segment(movieData.Tracks(movieData.TrackNum), BegFrameNum, EndFrameNum,'frames');
tr.Name = movieData.Movie;

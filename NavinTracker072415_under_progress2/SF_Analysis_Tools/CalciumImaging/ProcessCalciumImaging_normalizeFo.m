function [cellData FinalStretchTable ForwardRunStarts AllSmoothData] = ProcessCalciumImaging_normalizeFo(FileName,NSMflag,StretchLength,PositiveDataCutoff,FluorChangeCutoff,beginMin,stopMin)

function compareTwoGenotypes(folderWithBoth,Date)
   ...
   [dsd1_InclEnds rsd1_InclEnds FracDwell1_InclEnds FracRoam1_InclEnds] = AutomatedRoamDwellAnalysis_Pool_InclEnds(PathName,Date,string1);
   ...
   [dsd2_InclEnds rsd2_InclEnds FracDwell2_InclEnds FracRoam2_InclEnds] = AutomatedRoamDwellAnalysis_Pool_InclEnds(PathName,Date,string2);
    ...
    plotTwoHists(dsd1(1,:),dsd2(1,:),string1,string2,5);
    title('Dwell States');
    
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
    subplot(2,4,3);
    
    plotTwoHists(rsd1(1,:),rsd2(1,:),string1,string2,5);
    title('Roam States');
    
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    subplot(2,4,4);
    
    plotTwoHists(dsd1_InclEnds(1,:),dsd2_InclEnds(1,:),string1,string2,5);
    title('Dwell States, First/Last included');
    
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
    subplot(2,4,5);
    
    plotTwoHists(rsd1_InclEnds(1,:),rsd2_InclEnds(1,:),string1,string2,5);

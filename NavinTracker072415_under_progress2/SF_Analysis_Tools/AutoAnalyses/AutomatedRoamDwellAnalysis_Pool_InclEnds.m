function [dwellStateDurations roamStateDurations FractionDwelling FractionRoaming] = AutomatedRoamDwellAnalysis_Pool_InclEnds(folder,Date,Genotype)
    ...
    for(i = 3:NumFolders)
       ...
       if (length(fileList)>0)
        ...
        [dwellStateDurations roamStateDurations FractionDwelling FractionRoaming] = GetHistsAndRatioInclEnds(allTracks,Date,Genotype);

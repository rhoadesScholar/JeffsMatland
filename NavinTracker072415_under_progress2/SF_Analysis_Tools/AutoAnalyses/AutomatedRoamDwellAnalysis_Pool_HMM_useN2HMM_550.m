function [dwellStateDurations roamStateDurations FractionDwelling FractionRoaming TrackInfo] = AutomatedRoamDwellAnalysis_Pool_HMM_useN2HMM_550(allTracks,Date,Genotype,N2_TR,N2_E)
...
%     end
        ...
        ReversalInfo = getAllRevs_HMM_useN2HMM_longSpeed(allTracks,N2_TR,N2_E);
        [dwellStateDurations roamStateDurations FractionDwelling FractionRoaming] = GetHistsAndRatio_HMM_useN2HMM_550(allTracks,Date,Genotype,N2_TR,N2_E);

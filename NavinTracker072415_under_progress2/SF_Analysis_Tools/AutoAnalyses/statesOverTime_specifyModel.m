function meanState = statesOverTime_specifyModel(folder,NumFrames,estTR,estE)
    ...
    [expNewSeq expStates estTR estE] = getHMMStatesSpecifyTRandE_2(allTracks,30,estTR,estE)

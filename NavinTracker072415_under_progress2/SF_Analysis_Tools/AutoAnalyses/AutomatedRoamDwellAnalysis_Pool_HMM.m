function [dwellStateDurations, roamStateDurations, FractionDwelling, FractionRoaming, TrackInfo] = AutomatedRoamDwellAnalysis_Pool_HMM(folder,Date,Genotype)
    ...
    for(i = 3:NumFolders)
        ...
        ReversalInfo = getAllRevs_HMM(folder);

function [dwellStateDurations roamStateDurations FractionDwelling FractionRoaming TrackInfo] = AutomatedRoamDwellAnalysis_Pool(folder,Date,Genotype)
    ...
    for(i = 3:NumFolders)
        ...
        ReversalInfo = getAllRevs(folder);
        [dwellStateDurations roamStateDurations FractionDwelling FractionRoaming] = GetHistsAndRatio(allTracks,Date,Genotype);

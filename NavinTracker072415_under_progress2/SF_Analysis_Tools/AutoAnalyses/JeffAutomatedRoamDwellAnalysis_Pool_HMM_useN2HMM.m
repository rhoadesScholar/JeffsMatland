function [dwellStateDurations roamStateDurations FractionDwelling FractionRoaming TrackInfo] = JeffAutomatedRoamDwellAnalysis_Pool_HMM_useN2HMM(allTracks,Date,Genotype,N2_TR,N2_E)
...
%     end
        ...
        ReversalInfo = JeffgetAllRevs_HMM_useN2HMM_longSpeed(allTracks,N2_TR,N2_E);

function [xaxis yaxis_dwell yaxis_roam] = checkHistsVaryDw(trackDataforSp,trackDataforAngSp,ratio,binSize,slideSize,fps,RoamConst)
    ...
    for (i=(binSize/3):1:90)
        ...
        [stateList startingStateMap] = getStateSliding_Diff(trackDataforSp,trackDataforAngSp,ratio,binSize,slideSize,i,RoamConst,fps);

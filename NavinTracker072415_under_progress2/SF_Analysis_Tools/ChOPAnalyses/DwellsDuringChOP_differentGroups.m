function [ChOPDetails ConDetails estTR estE] = DwellsDuringChOP_differentGroups(folder,startStim,stopStim)
        ...
        for(i=1:((length(stateDurationMaster(j).stateCalls(:,1)))-1))
            if(stateDurationMaster(j).stateCalls(i,1)==1)
                ...
                if(length(checkforoverlap>12))
                    ...
                    simulStartStim3 = 9300;
                    simulStartStim4 = 9000;
                    simulStartStim5 = 8700;
                    simulStopStim = 9600+StimDuration_Frames-1;
                    simulStopStim2 = 10000+StimDuration_Frames-1;
                    simulStopStim3 = 9300+StimDuration_Frames-1;
                    simulStopStim4 = 9000+StimDuration_Frames-1;
                    simulStopStim5 = 8700+StimDuration_Frames-1;
                    ...
                    if((stateDurationMaster(j).stateCalls(i,3)>(simulStartStim-40) && stateDurationMaster(j).stateCalls(i,3)<simulStopStim && stateDurationMaster(j).stateCalls(i,4)<(simulStopStim+5400))||(stateDurationMaster(j).stateCalls(i,3)>(simulStartStim2-40) && stateDurationMaster(j).stateCalls(i,3)<simulStopStim2 && stateDurationMaster(j).stateCalls(i,4)<(simulStopStim2+5400))||(stateDurationMaster(j).stateCalls(i,3)>(simulStartStim3-40) && stateDurationMaster(j).stateCalls(i,3)<simulStopStim3 && stateDurationMaster(j).stateCalls(i,4)<(simulStopStim3+5400))||(stateDurationMaster(j).stateCalls(i,3)>(simulStartStim4-40) && stateDurationMaster(j).stateCalls(i,3)<simulStopStim4 && stateDurationMaster(j).stateCalls(i,4)<(simulStopStim4+5400))||(stateDurationMaster(j).stateCalls(i,3)>(simulStartStim5-40) && stateDurationMaster(j).stateCalls(i,3)<simulStopStim5 && stateDurationMaster(j).stateCalls(i,4)<(simulStopStim5+5400)))%0 or 1
                        %if((stateDurationMaster(j).stateCalls(i,4)<6840))
                            beginState = stateDurationMaster(j).stateCalls(i,3);
                            stopState = stateDurationMaster(j).stateCalls(i,4);
                            if(stateDurationMaster(j).stateCalls(i,3)<simulStopStim5)
                                simulStart = simulStartStim5;
                                simulStop = simulStopStim5;
                            elseif(stateDurationMaster(j).stateCalls(i,3)<simulStopStim4)
                                simulStart = simulStartStim4;
                                simulStop = simulStopStim4; 
                            elseif(stateDurationMaster(j).stateCalls(i,3)<simulStopStim3)
                                simulStart = simulStartStim3;
                                simulStop = simulStopStim3; 
                            elseif(stateDurationMaster(j).stateCalls(i,3)<simulStopStim)

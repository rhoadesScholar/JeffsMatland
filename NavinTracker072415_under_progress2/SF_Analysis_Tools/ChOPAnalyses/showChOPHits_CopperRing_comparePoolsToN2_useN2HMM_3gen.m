function [DwSpeedTest DwAngSpeedTest RoSpeedTest RoAngSpeedTest p_chi_Dw p_chi_Ro st_checkDw st_checkRo AllIndivData_Dw AllIndivData_Ro AllChOPHits AllChOPInfo_forBinnedData] = showChOPHits_CopperRing_comparePoolsToN2_useN2HMM_3gen(n2_folders,N2_stimulusfile,exp_folders,exp_stimulusfile,exp2_folders,exp2_stimulusfile,stimtoIncl,C128SFlag)
    
    %%%%% STILL HAS A BUG THAT NEEDS FIXING
    ...
    for(i=1:(length(n2_folders)))
        AllChOPHitsTemp = [];
        [AllChOPHitsTemp NumberofFOI estTR estE] = summarizeChOPdata_Copper_collectHMM_1minSurround(n2_folders{i},N2_stimulusfile,C128SFlag,stimtoIncl_N2);
    ...
    for(i=1:(length(exp2_folders)))
        ...
        exp2_stimulus = load(exp2_stimulusfile{i});
    
        if(stimtoIncl==0)
            %stimtoIncl_N2 = 1:1:length(N2_stimulus(:,1));
            stimtoIncl_exp2 = 1:1:length(exp2_stimulus(:,1));
        end
  
        AllChOPHitsTemp = [];
        AllChOPInfo_forBinnedDataTemp = [];
        [AllChOPHitsTemp AllChOPInfo_forBinnedDataTemp NumberofFOI] = summarizeChOPdata_Copper_useHMM_1minSurround(exp2_folders{i},exp2_stimulusfile{i},C128SFlag,stimtoIncl_exp2,estTR,estE);
        AllChOPHits2 = [AllChOPHits2; AllChOPHitsTemp];
        AllChOPInfo_forBinnedData2 = [AllChOPInfo_forBinnedData2; AllChOPInfo_forBinnedDataTemp];
    end
...
%%%%%Smoothen by 1sec
    ...
    for (i=1:(NumberofFOI/30))
        for(j=1:length(DwellStartIndices))
            ...
            DwSpeedMatrixTemp3_2(j,i) = mean(DwSpeedMatrixTemp_2(j,((i*30)-29):(i*30)));
            DwAngSpeedMatrixTemp3_2(j,i) = mean(DwAngSpeedMatrixTemp_2(j,((i*30)-29):(i*30)));
            DwStateMatrixTemp3_2(j,i) = round(mean(DwStateMatrixTemp_2(j,((i*30)-29):(i*30))));
...
%        display(FullCntrlDwellStartIndices)
    ...
    for (i=1:(NumberofFOI/9))
        for(j=1:length(DwellStartIndices))
            ...
            DwSpeedMatrixTemp3_3sec_2(j,i) = mean(DwSpeedMatrixTemp_2(j,((i*9)-8):(i*9)));
            DwAngSpeedMatrixTemp3_3sec_2(j,i) = mean(DwAngSpeedMatrixTemp_2(j,((i*9)-8):(i*9)));
...
%        display(FullCntrlDwellStartIndices)
    ...
    for(i=1:NumberofFOI/9)
        ...
        DwSpeedError3_3sec_2(i) = (nanstd(DwSpeedMatrixTemp3_3sec_2(:,i)))/(sqrt(length(DwellStartIndices2)));
        DwAngSpeedError3_3sec_2(i) = (nanstd(DwAngSpeedMatrixTemp3_3sec_2(:,i)))/(sqrt(length(DwellStartIndices2)));
    ...
    for(i=1:NumberofFOI/9)
        ...
        DwSpeedAve_3sec_2(i) = nanmean(DwSpeedMatrixTemp3_3sec_2(:,i));
        DwAngSpeedAve_3sec_2(i) = nanmean(DwAngSpeedMatrixTemp3_3sec_2(:,i));
...
%     end
     ...
     upper2 = DwSpeedAve_3sec_2+DwSpeedError3_3sec_2;
     lower2 = DwSpeedAve_3sec_2-DwSpeedError3_3sec_2;
     ...
     hold on; errorshade((1:NumberofFOI/9)*3,upper2,lower2,[0.8 0.8 0.8]);
     hold on; plot((1:NumberofFOI/9)*3,DwSpeedAve_3sec_2,'LineWidth',2,'color','green');
...
%     end
     ...
     hold on; errorshade((1:NumberofFOI/9)*3,DwAngSpeedAve_3sec_2+DwAngSpeedError3_3sec_2,DwAngSpeedAve_3sec_2-DwAngSpeedError3_3sec_2,[0.8 0.8 0.8]);
     hold on; plot((1:NumberofFOI/9)*3,DwAngSpeedAve_3sec_2,'LineWidth',2,'color','green');
...
%%%%%Get the data for states that start in a roam state
    ...
    RoamStartIndices2 = find(AllChOPHits2(:,3)==2);
    AllChOPHitsRo2 = AllChOPHits2(RoamStartIndices2,:);
 ...
 %   ControlChOPHitsRo = ControlChOPHits(RoamStartIndices,:);
    ...
    for(i=1:NumberofFOI)
        ...
        NumDw2 = length(find(AllChOPHitsRo2(:,i+((2*NumberofFOI)+4))==1));
        NumRo2 = length(find(AllChOPHitsRo2(:,i+((2*NumberofFOI)+4))==2));
        NumRo_ForChi2(i) = NumRo2;
        NumTotal2 = NumDw2+NumRo2;
        RoStates2(i) = NumRo2/NumTotal2;
   ...
   %    ControlRoStates(i) = nanmean(ControlChOPHitsRo(:,i+((2*NumberofFOI)+4)));
    ...
    RoSpeedMatrixTemp_2 = AllChOPHits2(RoamStartIndices2,5:(NumberofFOI+4));
    RoAngSpeedMatrixTemp_2 = abs(AllChOPHits2(RoamStartIndices2,(NumberofFOI+5):((2*NumberofFOI)+4)));
    RoStateMatrixTemp_2 = AllChOPHits2(RoamStartIndices2,((2*NumberofFOI)+5):((3*NumberofFOI)+4));
 ...
 %           ControlRoAngSpeedMatrixTemp3(j,i) = mean(ControlRoAngSpeedMatrixTemp(j,((i*30)-29):(i*30)));
    ...
    for (i=1:(NumberofFOI/3))
        for(j=1:length(RoamStartIndices))
            ...
            RoSpeedMatrixTemp3_3sec_2(j,i) = mean(RoSpeedMatrixTemp_2(j,((i*3)-2):(i*3)));
            RoAngSpeedMatrixTemp3_3sec_2(j,i) = mean(RoAngSpeedMatrixTemp_2(j,((i*3)-2):(i*3)));
            RoStateMatrixTemp3_3sec_2(j,i) = round(mean(RoStateMatrixTemp_2(j,((i*3)-2):(i*3))));
 ...
 %           ControlRoAngSpeedMatrixTemp3(j,i) = mean(ControlRoAngSpeedMatrixTemp(j,((i*30)-29):(i*30)));
    ...
    for(i=1:NumberofFOI/30)
     ...
     for(i=1:NumberofFOI/3)
        ...
        RoSpeedError3_3sec_2(i) = (nanstd(RoSpeedMatrixTemp3_3sec_2(:,i)))/(sqrt(length(RoamStartIndices2)));
        RoAngSpeedError3_3sec_2(i) = (nanstd(RoAngSpeedMatrixTemp3_3sec_2(:,i)))/(sqrt(length(RoamStartIndices2)));
    ...
    for(i=1:NumberofFOI/3)
        ...
        RoSpeedAve_3sec_2(i) = nanmean(RoSpeedMatrixTemp3_3sec_2(:,i));
        RoAngSpeedAve_3sec_2(i) = nanmean(RoAngSpeedMatrixTemp3_3sec_2(:,i));
...
%     end
    ...
    set(gca,'Color','b');
    hold on; plot((1:NumberofFOI)/3,RoStates2,'LineWidth',2,'color','green');
...
%     end
     ...
     upper2 = RoSpeedAve_3sec_2+RoSpeedError3_3sec_2;
     lower2 = RoSpeedAve_3sec_2-RoSpeedError3_3sec_2;
     ...
     hold on; plot((1:NumberofFOI/3),RoSpeedAve_3sec_2,'LineWidth',2,'color','green');
...
%     set(1,'Name',folder);
    ...
    stimulusShade(x,0,100,[0.678 0.922 1]); hold on;
     ...
     hold on; errorshade((1:NumberofFOI/3),RoAngSpeedAve_3sec_2+RoAngSpeedError3_3sec_2,RoAngSpeedAve_3sec_2-RoAngSpeedError3_3sec_2,[0.8 0.8 0.8]);
     hold on; plot((1:NumberofFOI/3),RoAngSpeedAve_3sec_2,'LineWidth',2,'color','green');

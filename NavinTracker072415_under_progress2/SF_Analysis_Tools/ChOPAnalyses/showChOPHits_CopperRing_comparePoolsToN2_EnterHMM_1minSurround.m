function [DwSpeedTest DwAngSpeedTest RoSpeedTest RoAngSpeedTest p_chi_Dw p_chi_Ro st_checkDw st_checkRo AllIndivData_Dw AllIndivData_Ro AllChOPHits AllChOPInfo_forBinnedData] = showChOPHits_CopperRing_comparePoolsToN2_EnterHMM_1minSurround(n2_folders,N2_stimulusfile,exp_folders,exp_stimulusfile,stimtoIncl,C128SFlag,estTR,estE)
    FullControlChOPHits = [];
    AllChOPHits = [];
    ...
    for(i=1:(length(n2_folders)))
        ...
        AllChOPHitsTemp = [];
        [AllChOPHitsTemp AllChOPInfo_forBinnedDataTemp NumberofFOI] = summarizeChOPdata_Copper_useHMM_1minSurround(n2_folders{i},N2_stimulusfile{i},C128SFlag,stimtoIncl_N2,estTR,estE);

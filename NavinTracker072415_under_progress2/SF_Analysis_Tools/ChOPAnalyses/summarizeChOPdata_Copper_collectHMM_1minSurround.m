...
function [AllChOPHits NumberofFOI estTR estE] = summarizeChOPdata_Copper_collectHMM_1minSurround(folder,stimulusfile,C128SFlag,stimtoIncl)
   ...
   %%%%%%%%%%calculate HMM based on all data from all animals
    ...
    for(i=1:length(ChOPfinalTracks))
        ...
        for(j=1:numStimuli)
            ...
            StartIndex = (ChOPFrames((lengthofStimFrames*j)-(lengthofStimFrames-1)))-180;

function [dwellStateDurations roamStateDurations FractionDwelling FractionRoaming estTR estE mean_dw_stab mean_dw_stab_err mean_dw_stab_vector mean_ro_stab mean_ro_stab_err mean_ro_stab_vector all_dw_speed_info all_ro_speed_info] = GetHistsAndRatioInclEnds_HMM_collectN2HMM(finalTracks,Date,Genotype)
    cmap = [jet(255)];
    colormap(cmap);

function [expNewSeq expStates estTR estE] = getHMMStates(finalTracks,binSize) %binSize should be 30 (frames)
%estTR = HMM transition matrix
%estE = HMM emission matrix
%expNewSeq - data from finalTracks
%expState - data from finalTracks

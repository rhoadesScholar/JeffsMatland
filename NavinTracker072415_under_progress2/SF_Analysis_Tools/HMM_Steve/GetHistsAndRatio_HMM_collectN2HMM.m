function [dwellStateDurations roamStateDurations FractionDwelling FractionRoaming estTR estE] = GetHistsAndRatio_HMM_collectN2HMM(finalTracks,Date,Genotype)
    cmap = [jet(255)];
    colormap(cmap);

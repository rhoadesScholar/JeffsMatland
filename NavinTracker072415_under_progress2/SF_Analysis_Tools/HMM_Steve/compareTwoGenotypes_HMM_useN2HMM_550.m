function [dsd1_InclEnds, rsd1_InclEnds, dsd2_InclEnds, rsd2_InclEnds] = compareTwoGenotypes_HMM_useN2HMM_550(N2tracks, otherTracks,Date, otherGenotype)
...
%     dirList = dirList(3:4,:);
    ...
    string1 = 'N2'; %deblank(dirList(1,:)); 
    
%    PathName = sprintf('%s/%s/',PathofFolder,string1);
%     display(PathName)
   [dsd1, rsd1, FracDwell1, FracRoam1, TrackInfo1, N2_TR, N2_E] = AutomatedRoamDwellAnalysis_Pool_HMM_collectN2HMM(N2tracks,Date,string1);
   ...
   [dsd1_InclEnds, rsd1_InclEnds, FracDwell1_InclEnds, FracRoam1_InclEnds, N2_TR_InclEnds, N2_E_InclEnds, mean_dw_stab1, mean_dw_stab_err1, mean_dw_stab_vector1, mean_ro_stab1, mean_ro_stab_err1, mean_ro_stab_vector1]...
       = GetHistsAndRatioInclEnds_HMM_collectN2HMM(N2Tracks,Date,string1);
   ...
   TrackInfo1.roam_state_durations_incl_ends = rsd1_InclEnds;
    ...
    %display(NewFilename)
    PathofFolderforSave = pwd; %sprintf('%s',PathName);
   ...
   string2 = otherGenotype; 

%    PathName = sprintf('%s/%s/',PathofFolder,string2);

   [dsd2 rsd2 FracDwell2 FracRoam2 TrackInfo2] = AutomatedRoamDwellAnalysis_Pool_HMM_useN2HMM_550(otherTracks,Date,string2,N2_TR,N2_E);
   ...
   [dsd2_InclEnds rsd2_InclEnds FracDwell2_InclEnds FracRoam2_InclEnds mean_dw_stab2 mean_dw_stab_err2 mean_dw_stab_vector2 mean_ro_stab2 mean_ro_stab_err2 mean_ro_stab_vector2] = GetHistsAndRatioInclEnds_HMM_useN2HMM_550(otherTracks,Date,string2,N2_TR,N2_E);

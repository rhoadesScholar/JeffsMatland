function [dwellStateDurations roamStateDurations FractionDwelling FractionRoaming mean_dw_stab mean_dw_stab_err mean_dw_stab_vector mean_ro_stab mean_ro_stab_err mean_ro_stab_vector] = GetHistsAndRatioInclEnds_HMM_useN2HMM_550(finalTracks,Date,Genotype,N2_TR,N2_E)
    cmap = [jet(255)];
    colormap(cmap);

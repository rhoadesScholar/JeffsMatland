function JeffcompareTwoGenotypes_HMM(Genotype1, allTracks1, Genotype2, allTracks2, Date)
...
%     
%    PathName = sprintf('%s/%s/',PathofFolder,Genotype1);
%     display(PathName)

   [dsd1 rsd1 FracDwell1 FracRoam1 TrackInfo1] = JeffAutomatedRoamDwellAnalysis_Pool_HMM(allTracks1,Date,Genotype1);
...
%    [dsd1_InclEnds rsd1_InclEnds FracDwell1_InclEnds FracRoam1_InclEnds] = AutomatedRoamDwellAnalysis_Pool_InclEnds_HMM(PathName,Date,Genotype1);
    [dsd1_InclEnds rsd1_InclEnds FracDwell1_InclEnds FracRoam1_InclEnds] = GetHistsAndRatioInclEnds_HMM(allTracks1,Date,Genotype1);

%    Genotype2 = deblank(dirList(2,:)); 
% 
%    PathName = sprintf('%s/%s/',PathofFolder,Genotype2);

   [dsd2 rsd2 FracDwell2 FracRoam2 TrackInfo2] = JeffAutomatedRoamDwellAnalysis_Pool_HMM(allTracks2,Date,Genotype2);
...
%    [dsd2_InclEnds rsd2_InclEnds FracDwell2_InclEnds FracRoam2_InclEnds] = AutomatedRoamDwellAnalysis_Pool_InclEnds_HMM(PathName,Date,Genotype2);
   [dsd2_InclEnds rsd2_InclEnds FracDwell2_InclEnds FracRoam2_InclEnds] = GetHistsAndRatioInclEnds_HMM(allTracks2,Date,Genotype2);
    ...
    plotTwoHists(dsd1(1,:),dsd2(1,:),Genotype1,Genotype2,10);
    title('Dwell States');
    
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
    subplot(2,4,3);
    
    plotTwoHists(rsd1(1,:),rsd2(1,:),Genotype1,Genotype2,10);
    title('Roam States');
    
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    subplot(2,4,4);
    
    plotTwoHists(dsd1_InclEnds(1,:),dsd2_InclEnds(1,:),Genotype1,Genotype2,10);
    title('Dwell States, First/Last included');
    
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
    subplot(2,4,5);
    
    plotTwoHists(rsd1_InclEnds(1,:),rsd2_InclEnds(1,:),Genotype1,Genotype2,10);
    ...
    legend1 = sprintf('%s.Dwell',Genotype1);
    legend2 = sprintf('%s.Dwell',Genotype2);
    legend3 = sprintf('%s.Roam',Genotype1);
    ...
    %%%%Save Figure
    CompName = sprintf('%s.%s.%s',Date,Genotype1,Genotype2);

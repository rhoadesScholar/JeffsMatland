function [finalTracks leftoverTracks] = processLinkedTracks(Tracks,rawTracks,movieName)
...
ShortTrackIndex = find(NumFramesAll < 3600);
...
[filepath,filePrefix,extension] = fileparts(sprintf('%s',movieName));
